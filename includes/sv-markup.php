<?php
	...
	$sv_plugin_images_dir = plugins_url( 'images/', dirname( __FILE__ ) );
?>
	...
	<div id="sv_container">
		...
		<div id="sv_main_content">
			...
			<div id="sv_shingle_color" class="sv_dropdown">
				...
				<img src="<?php echo( $sv_plugin_images_dir . 'iko_marathon_dual_black.jpg' ); ?>" alt="Dual Black" id="dual_black" />
				<img src="<?php echo( $sv_plugin_images_dir . 'check-mark-blue-48.png' ); ?>" alt="Check Mark" class="sv_check_mark" />
			</div>
